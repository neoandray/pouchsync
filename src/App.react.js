                ...
                <div className="card-body">
                  ...
                  <div className="direct-chat-messages">
                    ...
                    <div className="direct-chat-msg">
                      ...
                      <img className="direct-chat-img" src="dist/img/user1-128x128.jpg" alt="message user image"></img>
                    ...
                    <div className="direct-chat-msg right">
                      ...
                      <img className="direct-chat-img" src="dist/img/user3-128x128.jpg" alt="message user image"></img>
                  ...
                  <div className="direct-chat-contacts">
                    <ul className="contacts-list">
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="dist/img/user1-128x128.jpg" alt="User Avatar"></img>
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="dist/img/user7-128x128.jpg" alt="User Avatar"></img>
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="dist/img/user3-128x128.jpg" alt="User Avatar"></img>
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="dist/img/user5-128x128.jpg" alt="User Avatar"></img>
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="dist/img/user6-128x128.jpg" alt="User Avatar"></img>
                      ...
                      <li>
                        <a href="#">
                          <img className="contacts-list-img" src="dist/img/user8-128x128.jpg" alt="User Avatar"></img>
                  ...
                  <ul className="todo-list" data-widget="todo-list">
                    <li>
                      ...
                      <div  className="icheck-primary d-inline ml-2">
                        <input type="checkbox" defaultValue="" name="todo1" id="todoCheck1"></input>
                    ...
                    <li>
                      ...
                      <div  className="icheck-primary d-inline ml-2">
                        <input type="checkbox" defaultValue="" name="todo2" id="todoCheck2" defaultChecked></input>
                    ...
                    <li>
                      ...
                      <div  className="icheck-primary d-inline ml-2">
                        <input type="checkbox" defaultValue="" name="todo3" id="todoCheck3"></input>
                    ...
                    <li>
                      ...
                      <div  className="icheck-primary d-inline ml-2">
                        <input type="checkbox" defaultValue="" name="todo4" id="todoCheck4"></input>
                    ...
                    <li>
                      ...
                      <div  className="icheck-primary d-inline ml-2">
                        <input type="checkbox" defaultValue="" name="todo5" id="todoCheck5"></input>
                    ...
                    <li>
                      ...
                      <div  className="icheck-primary d-inline ml-2">
                        <input type="checkbox" defaultValue="" name="todo6" id="todoCheck6"></input>
